...
public class Application {
    ...
    /** Keeps invitation history after the candidate accepts or declines it. */
    @Column(name = "invitation_origin", nullable = false)
    private boolean invitationOrigin = false;

    /** A withdrawn invitation is retained for audit but hidden from both workspaces. */
    @Column(name = "invitation_withdrawn", nullable = false)
    private boolean invitationWithdrawn = false;
    ...
    public boolean isInvitationOrigin()               { return invitationOrigin; }
    public void setInvitationOrigin(boolean value)    { this.invitationOrigin = value; }
    public boolean isInvitationWithdrawn()            { return invitationWithdrawn; }
    public void setInvitationWithdrawn(boolean value) { this.invitationWithdrawn = value; }
