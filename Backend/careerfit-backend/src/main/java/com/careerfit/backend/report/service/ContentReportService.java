...
public class ContentReportService {
    ...
    private boolean authorizeTargetView(ContentReport.TargetType type, UUID targetId,
        ...
        boolean recruiterCanView = viewer.getRole() == UserAccount.Role.RECRUITER
                && (applicationRepo.existsByCvIdAndJobRecruiterId(targetId, viewer.getId())
                || matchingRepo.existsByCvIdAndJobRecruiterId(targetId, viewer.getId()));
        if (!admin && !ownerCanView && !recruiterCanView) {
