 ...
 */
public class CvDtos {
    public record ManualCvDraftRequest(String displayName, String fullName, String desiredTitle, String seniorityLevel, Integer yearsOfExperience, String email, String phone, String location, String summary, java.util.List<String> skills, java.util.List<String> niceToHaveSkills, String workExperience, String education, String projects, String certifications, String languages, String language) {}
    ...
    public record UpdateCvReviewRequest(String displayName, java.util.Map<String, String> sections) {}
    ...
    public record CvDetailResponse(
        ...
        String parsedSummary,
        String rawText,
        java.util.Map<String, String> reviewSections,
        List<CvReviewIssue> reviewIssues,
