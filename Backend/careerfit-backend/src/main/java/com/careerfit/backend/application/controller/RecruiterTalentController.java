...
public class RecruiterTalentController {
    ...
    public ResponseEntity<ApiResponse<List<ApplicationDtos.TalentCandidateCardResponse>>> listBookmarks(
    ...
    public ResponseEntity<ApiResponse<ApplicationDtos.TalentCandidateCardResponse>> bookmark(
            @PathVariable UUID jobId,
