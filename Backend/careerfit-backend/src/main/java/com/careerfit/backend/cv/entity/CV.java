...
public class CV {
    ...
    @Column(name = "original_raw_text", columnDefinition = "text")
    private String originalRawText;

    @JdbcTypeCode(SqlTypes.JSON)
    @Column(name = "review_sections", columnDefinition = "jsonb")
    private String reviewSectionsJson;

    @JdbcTypeCode(SqlTypes.JSON)
    @Column(name = "review_issues", columnDefinition = "jsonb")
    ...
    public enum CvStatus { UPLOADED, VALIDATING, REVIEW_REQUIRED, PROCESSING, SCORING_DONE, FAILED, DRAFT, BANNED }
    ...
    public void setOriginalRawText(String t)         { this.originalRawText = t; }
    public String getReviewSectionsJson()            { return reviewSectionsJson; }
    public void setReviewSectionsJson(String j)      { this.reviewSectionsJson = j; }
    public String getReviewIssuesJson()              { return reviewIssuesJson; }
    public void setReviewIssuesJson(String j)        { this.reviewIssuesJson = j; }
