    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.POST, "/api/reports/jobs/**").hasRole("CANDIDATE")
                .requestMatchers(HttpMethod.POST, "/api/reports/cvs/**").hasRole("RECRUITER")
                ...
                .requestMatchers(HttpMethod.POST, "/api/jobs", "/api/jobs/drafts", "/api/jobs/quality-preview").hasRole("RECRUITER")
