...
# Regex to match from the javadoc of getRecommendations to its closing brace
pattern = re.compile(r'\s*/\*\*[\s\S]*?public List<JobRecommendation> getRecommendations.*?toList\(\);\n    }', re.MULTILINE)
