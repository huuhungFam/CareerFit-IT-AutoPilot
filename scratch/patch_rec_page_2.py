...
# Match function RecommendationsPage() { ... }
pattern = re.compile(r'function RecommendationsPage\(\)\s*\{[\s\S]*?\n\}\n\nfunction ApplicationsPage', re.MULTILINE)
content = pattern.sub(new_code + '\n\nfunction ApplicationsPage', content)
