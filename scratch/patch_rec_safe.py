...
old_code = """    @Transactional(readOnly = true)
...
new_code = """    public record CatalogResponse(
...
if old_code in content:
    ...
    with open('Backend/careerfit-backend/src/main/java/com/careerfit/backend/recommendation/service/RecommendationService.java', 'w', encoding='utf-8') as f:
        f.write(content)
    print("Replaced RecommendationService successfully")
else:
    print("Could not find old code in RecommendationService!")
