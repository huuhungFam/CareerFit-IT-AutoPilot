...
content = """# Phase 2 Implementation Report: Settings UI, Polling, Catalog, and CV UX
...
with open('prompt-gemini/11-04-settings-ui-polling-catalog-and-cv-report.md', 'w', encoding='utf-8') as f:
    f.write(content)
